...
PROJECT_NAME := provider-jet-dynatracedamyan
...
export TERRAFORM_NATIVE_PROVIDER_BINARY := terraform-provider-dynatrace_1.11.1
...
IMAGES = provider-jet-dynatracedamyan provider-jet-dynatracedamyan-controller
